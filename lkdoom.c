...
int main( int argc, char *argv[])
{
    ...
    while ( gameover == 0 ) 
    {
       ...
       ansigotoyx( rows-1, 0 );
       printf( "|%s|F|%d|[%s]", "LKDOOM" , nexp_user_sel[pansel] ,  nexp_user_fileselection );
       ...
       else if ( ch == 'r' ) 
       {
           ...
           strncat( string , " prboom-plus -iwad DOOM2.WAD -net 192.168.52.19  -warp 1  -file " , PATH_MAX - strlen( string ) -1 );
       ...
       {
           strncpy( string , "  " , PATH_MAX );
           strncat( string , " prboom-plus -iwad DOOM2.WAD  -warp 1  -file " , PATH_MAX - strlen( string ) -1 );
           strncat( string , " " , PATH_MAX - strlen( string ) -1 );
           strncat( string , " \"" , PATH_MAX - strlen( string ) -1 );
           strncat( string ,  nexp_user_fileselection , PATH_MAX - strlen( string ) -1 );
           strncat( string , "\" " , PATH_MAX - strlen( string ) -1 );
